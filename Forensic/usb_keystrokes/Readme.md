...
We know that we have a keylogger so for that we need to extract the data from the USB device.

- We get the data from wirshark on one file useing the tshark
- We collect all the HID Data in order
- We save on diffrent file with this fortmat 00:00:00:00:00:00:00:00

and we found a script on github that can convert the data to a readable format.
...
if __name__ == '__main__':
    sys.stdout.write(read_use("keyboard.txt"))

```

flag:

`CSC25{usB_f0r3nsic5s_re4lly_rock5!}`
